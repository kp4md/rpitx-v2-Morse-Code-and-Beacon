...
Rpitx v2 by Evariste Courjaud, F5OEO, renders Morse Code that is difficult to decode due to unusual element and character spacing and rhythm.  Here are an improved morse C++ source code and executable that correct the timing, includes punctuation, and a new bash script that implements a repeated Morse Code beacon message.
