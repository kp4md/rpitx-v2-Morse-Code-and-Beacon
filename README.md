...
Add [cw_beacon.sh](https://github.com/kp4md/rpitx-v2-Morse-Code-and-Beacon/blob/main/cw_beacon.sh) shell script in the rpitx folder, substituting your own Frequency, Morse Code speed, Cycle period and Message into the first four declarations.
